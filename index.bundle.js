...
/***/ (function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_Game2.default, null), app);
	...
	var Game = function (_React$Component) {
	  ...
	  function Game() {
	    ...
	    _this.state = {
	      rowSize: rowSize,
	      colSize: colSize,
	      cards: Array(rowSize).fill(Array(colSize).fill(0))
	    };
	    return _this;
	  }
	  ...
	  _createClass(Game, [{
	    ...
	    value: function handleClick(i, j) {
	      var cards = this.state.cards.map(function (x) {
	        return x.slice(0);
	      });
	      console.log(cards);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Board(props) {
	  ...
	  function renderRow(row, row_index) {
	    var out = row.map(function (card, col_index) {
	      return renderCard(row_index, col_index);
	    });
	    return React.createElement(
	      'div',
	      { className: 'board-row' },
	  ...
	  console.log(cards);
	  var rows = cards.map(function (row, row_index) {
	    return React.createElement(
	      'div',
	      { className: 'board-row' },
